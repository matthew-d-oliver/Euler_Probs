...
for k in range(20):	#checks vertical products
	for l in range(16):
		checkr = Griddle[k][l]*Griddle[k][l+1]*Griddle[k][l+2]*Griddle[k][l+3]
		if checkr>hi_score: hi_score = checkr

for k in range(16):	#checks horizontal products
	for l in range(20):
		checkr = Griddle[k][l]*Griddle[k+1][l]*Griddle[k+2][l]*Griddle[k+3][l]
		if checkr>hi_score: hi_score = checkr

for k in range(16):	#checks horizontal products
	for l in range(16):
		checkr = Griddle[k][l]*Griddle[k+1][l+1]*Griddle[k+2][l+2]*Griddle[k+3][l+3]
		if checkr>hi_score: hi_score = checkr
for k in range(3,20):	#checks  other horizontal products
	for l in range(16):
		checkr = Griddle[k][l]*Griddle[k-1][l+1]*Griddle[k-2][l+2]*Griddle[k-3][l+3]
		if checkr>hi_score: hi_score = checkr
